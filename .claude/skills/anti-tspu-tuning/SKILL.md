...
| `SHADOWLINK_SWEEP_PHASE_JITTER` | 4s | подтиковое размазывание **момента дренажа**. `-1s` выключает ровно. Заведён 2026-08-14: все 588 age-ротаций легли в одну фазу 5s-сетки (σ 0.0001s), 92.2% connect'ов в одном 1s-окне — stagger это не лечит, он правит порог, а не момент. ⚠ Платит возрастом до +4s → в полосу с hazard 2.1%/проход |
