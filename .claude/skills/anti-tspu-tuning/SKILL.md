...
Hazard-кривая по данным двух прогонов **монотонно растёт с 80 с**, удваиваясь
примерно каждые 5 с; ступеньки на 84 с нет ни в одном. ⚠ Посчитано **офлайн по
логам** (восстановление времён жизни из пар `reader started` → терминальное
событие), а НЕ выходом `slotobs.Hazard` — тот появился в коде тем же днём и в
логах прогонов 08-11/08-12 его ещё нет. Воспроизводить на новых прогонах уже
можно по строке `slot death hazard`.
